export default {
    ...
    badge: {
      ...
      primary: 'text-white bg-custom-red-100 dark:text-white dark:bg-custom-red-600',
    },
    // Backdrop
    backdrop: {
      base:
    ...
    button: {
      ...
      primary: {
        base: 'text-white bg-custom-red-600 border border-transparent',
        active: 'active:bg-custom-red-600 hover:bg-custom-red-700 focus:ring focus:ring-purple-300',
        disabled: 'opacity-50 cursor-not-allowed',
      },
      outline: {
